...
public class MasterDataValidatorTests
{
    ...
    {
        var errors = MasterDataValidator.Validate([], ValidFurniture(), ValidRoomGrades());
    ...
    public void Validate_WithDuplicateCharacterIds_ReturnsFailure()
    {
        ...
        var errors = MasterDataValidator.Validate(characters, ValidFurniture(), ValidRoomGrades());
    ...
    {
        var errors = MasterDataValidator.Validate(ValidCharacters(), [], ValidRoomGrades());
    ...
    public void Validate_WithDuplicateFurnitureIds_ReturnsFailure()
    {
        ...
        var errors = MasterDataValidator.Validate(ValidCharacters(), furniture, ValidRoomGrades());
    ...
    {
        var errors = MasterDataValidator.Validate(ValidCharacters(), ValidFurniture(), []);
    ...
    public void Validate_WithDuplicateRoomGrade_ReturnsFailure()
    {
        ...
        var errors = MasterDataValidator.Validate(ValidCharacters(), ValidFurniture(), roomGrades);
